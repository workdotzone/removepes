...
const services = [
  { title: 'Cockroach Control', description: 'Eliminate cockroaches completely with safe gel bait and spray treatment.', features: ['German & American Cockroaches', '100% Safe for Family', 'Guaranteed Results', '3-Month Warranty'], image: '/images/services/cockroach-control.png' },
  { title: 'Termite Control', description: 'Complete termite elimination with soil treatment, baiting, and wood treatment.', features: ['Soil Treatment', 'Wood Treatment', 'Baiting System', '1 Year Warranty'], image: '/images/services/fly-termite.png' },
  { title: 'Rodent Control', description: 'Get rid of rats and mice permanently with trapping and exclusion.', features: ['Trapping & Removal', 'Exclusion & Sealing', 'Monitoring Systems', 'Prevention Tips'], image: '/images/services/rodent-control.png' },
  { title: 'Bed Bugs Treatment', description: 'Complete bedbug elimination with heat and chemical treatment.', features: ['Heat Treatment', 'Chemical Treatment', '2 Follow-up Visits', '45-Day Warranty'], image: '/images/services/bed-bugs.png' },
  { title: 'Mosquito Control', description: 'Protect from dengue and malaria with fogging and larviciding.', features: ['ULV Fogging', 'Larvae Control', 'Society Programs', 'Disease Prevention'], image: '/images/services/mosquito-control.png' },
  { title: 'Fly Control', description: 'Fly elimination with ILTs, baiting, and larval control. FSSAI compliant.', features: ['Insect Light Traps', 'Fly Bait Stations', 'Larval Control', 'FSSAI Compliant'], image: '/images/services/fly-control.png' },
  { title: 'Ants Control', description: 'Eliminate ant colonies completely with gel baiting and barrier spray.', features: ['Colony Elimination', 'Gel Bait Treatment', 'Prevention Barriers', 'Long-Lasting Results'], image: '/images/services/ants-control.png' },
  { title: 'Spider Control', description: 'Safe removal of spiders with web removal and residual spray.', features: ['Web Removal', 'Residual Spray', 'Preventive Barrier', 'Family-Friendly'], image: '/images/services/spider-control.png' },
  { title: 'Wood Borer Control', description: 'Protect wooden furniture and structures from wood-boring insects.', features: ['Pre-Treatment', 'Post-Treatment', 'Wood Injection', '6-Month Warranty'], image: '/images/services/wood-borer-control.png' },
  { title: 'Honey Bee Control', description: 'Humane bee relocation and hive removal by trained professionals.', features: ['Live Bee Relocation', 'Hive Removal', 'Eco-Friendly', 'Emergency Service'], image: '/images/services/honey-bee-control.png' },
  { title: 'Bird Nesting Control', description: 'Humane bird deterrents including netting, spikes, and exclusion.', features: ['Bird Netting', 'Anti-Roosting Spikes', 'Humane Methods', 'High-Rise Capable'], image: '/images/services/bird-control.png' },
  { title: 'Weed Control', description: 'Remove weeds with selective herbicides, manual removal, and prevention.', features: ['Herbicide Application', 'Manual Removal', 'Pre-Emergent Treatment', 'Eco-Responsible'], image: '/images/services/weed-control.png' },
  { title: 'Sanitization Services', description: 'Complete disinfection with ULV fogging and hospital-grade chemicals.', features: ['Hospital-Grade Chemicals', 'ULV Fogging', 'NABL Certified', 'Certificate Provided'], image: '/images/services/sanitaisation.png' },
  { title: 'General Pest Control', description: 'Comprehensive multi-pest treatment for cockroaches, ants, spiders, and crawling insects.', features: ['Multi-Pest Treatment', 'Customized AMC Plans', 'Indoor & Outdoor', 'Expert Assessment'], image: '/images/services/genral-pest-control.png' },
  { title: 'Rats Control', description: 'Professional rat removal with heavy-duty traps, baiting, and exclusion.', features: ['Heavy-Duty Traps', 'Rodenticide Baiting', 'Burrow Treatment', 'Monitoring Stations'], image: '/images/services/rats-control.png' },
];
